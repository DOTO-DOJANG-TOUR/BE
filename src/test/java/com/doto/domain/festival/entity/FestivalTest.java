    ...
    class 생성 {
        ...
        void 축제_정보와_WGS84_위치로_생성된다() {
            ...
            Festival festival = Festival.create(
                    ...
                    "18:00~19:30", "10:00~22:00", "월요일", "무료", "가능", "무료", "주요 프로그램", Region.서울특별시, RegionGroup.서울,
            ...
            assertThat(festival.getLegalRegion()).isEqualTo(Region.서울특별시);
            assertThat(festival.getLegalGungu()).isEqualTo(RegionGroup.서울);
